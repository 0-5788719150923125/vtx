...
To build a non-trivial, opinionated framework for human cloning experiments. Our goal is to standardize AGIs (Artificial General Interfaces) via small models, on commodity hardware (i.e. your desktop computer).
