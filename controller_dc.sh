# controller_dc.sh - docker-compose edition

# This file is essentially identical to the main controller.sh file,
# except that the "docker-compose" command has been replaced with "docker-compose".

# This change is particularly useful for Ubuntu users or those who frequently
# encounter issues with the docker-compose command. It serves as a workaround
# to alleviate any recurring problems related to docker-compose usage.
